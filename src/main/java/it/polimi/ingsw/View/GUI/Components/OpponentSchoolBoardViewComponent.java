...
public class OpponentSchoolBoardViewComponent extends GridPane {
    ...
    public OpponentSchoolBoardViewComponent(String nickname){
        ...
        placeHolder = new StudentViewComponent(PawnDiscColor.BLUE);
        placeHolder.setFitHeight(15);
        placeHolder.setFitWidth(15);
        add(placeHolder, 0, 2);
        add(blueStudents, 1, 2);
        placeHolder = new StudentViewComponent(PawnDiscColor.GREEN);
        placeHolder.setFitHeight(15);
        placeHolder.setFitWidth(15);
        add(placeHolder, 0, 3);
        add(greenStudents, 1, 3);
        placeHolder = new StudentViewComponent(PawnDiscColor.RED);
        placeHolder.setFitHeight(15);
        placeHolder.setFitWidth(15);
        add(placeHolder, 0, 4);
        add(redStudents, 1, 4);
        placeHolder = new StudentViewComponent(PawnDiscColor.YELLOW);
        placeHolder.setFitHeight(15);
        placeHolder.setFitWidth(15);
        add(placeHolder, 0, 5);

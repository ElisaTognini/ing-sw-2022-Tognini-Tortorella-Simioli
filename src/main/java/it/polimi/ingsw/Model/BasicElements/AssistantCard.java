...
public final class AssistantCard implements Comparable{
    ...
    *
    * @param Object - in this case, in order for the method to return correctly, it is an AssistantCard chosen
    ...
    *
    * @param Object - the assistant card played (and stored) by the player
